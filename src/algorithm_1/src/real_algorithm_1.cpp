...
double long_goal = -96.475250;

void gps_define(const geometry_msgs::Pose2D &msg)
{
...
void heading_define(const geometry_msgs::Pose2D &msg)
{
...
int main(int argc, char** argv) {
  ros::init(argc, argv, "real_algorithm_1");
  ros::NodeHandle n;

  // Get estimates for current lat, long, and heading, and call functions
  gps_sub = n.subscribe("/UBX/Combined", 500, gps_define);
  heading_sub = n.subscribe("/UBX/Combined", 500, heading_define);
